...
RESOURCE_GROUP_NAME = 'PythonAzureExample-WebApp-rg1'
LOCATION = "centralus"
...
WEB_APP_NAME = os.environ.get(
    "WEB_APP_NAME", f"PythonAzureExample-WebApp1-{random.randint(1,100000):05}")
...
print(RESOURCE_GROUP_NAME,  WEB_APP_NAME, LOCATION, plan_result.id)
